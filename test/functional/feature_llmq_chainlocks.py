...
from test_framework.test_framework import CointaftTestFramework
...
class LLMQChainLocksTest(CointaftTestFramework):
    def set_test_params(self):
        self.set_cointaft_test_params(6, 5, fast_dip3_enforcement=True)
