...
official/supported Docker Images found at https://hub.docker.com/r/cointaft/cointaftd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/cointaft/cointaftd-develop/ when changing the above text**