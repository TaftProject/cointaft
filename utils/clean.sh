...
rm -f src/config/cointaft-config.h
...
rm -rf test_bitcoin.coverage/ cointaft-gtest.coverage/ total.coverage/
...
clean_exe src/cointaft-cli
clean_exe src/cointaftd
clean_exe src/cointaft-gtest
clean_exe src/cointaft-tx
clean_exe src/test/test_cointaft
clean_exe src/test/test_cointaft_fuzzy
...
clean_dep . src/config/cointaft-config.h.in
