...
This document provides guidelines for internationalization of the Cointaft Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cointaft_en.ts` remains unchanged.
