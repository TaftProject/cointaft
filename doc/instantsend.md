...
This mechanism has been integrated into Bitcore-Node-Cointaft which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TaftProject/insight-api-cointaft#web-socket-api](https://github.com/TaftProject/insight-api-cointaft#web-socket-api)
* API: [https://github.com/TaftProject/insight-api-cointaft#instantsend-transactions](https://github.com/TaftProject/insight-api-cointaft#instantsend-transactions)
