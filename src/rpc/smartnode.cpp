...
void smartnode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the smartnode owner Cointaft address\n"
            "  payee          - Print the smartnode payout Cointaft address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the smartnode operator public key\n"
            "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the smartnode voting Cointaft address\n"
        );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "cointaft",               "smartnode",             &smartnode,             {} },
    { "cointaft",               "smartnodelist",         &smartnodelist,         {} },
};
