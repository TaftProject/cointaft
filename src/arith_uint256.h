...
#ifndef COINTAFT_ARITH_UINT256_H
#define COINTAFT_ARITH_UINT256_H
...
public:
     ...
     *
     * Cointaft only uses this "compact" format for encoding difficulty
...
#endif // COINTAFT_ARITH_UINT256_H
