...
/** Utility functions used by the Cointaft Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cointaft:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load cointaft specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a cointaft specific theme is activated (light/dark).*/
