    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  cointaft-qt [command-line options]                     \n";
...
All the Cointaft in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 TAFT, 0.01 TAFT, 0.1 TAFT, 1 TAFT and 10 TAFT -- sort of like the paper money you use every day.</li> \
