...
//! Interface for the src/evo part of a cointaft node (cointaftd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a cointaft node (cointaftd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a cointaft node (cointaftd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a cointaft node (cointaftd process).
class Node
{
public:
    virtual ~Node() {}
