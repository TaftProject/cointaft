...
{
    const char* pszTimestamp = "The Times 14/March/2023 TAFT is ticker of COINTAFT for new generation Blockchain";
    const CScript genesisOutputScript = CScript() << ParseHex("04d335872ed13a976b840283734951f648fbdcd54c851e8904317f6b6bf887a36cd4272293ca917b70d473c963de1eec28c1e7fec6dd71ca7fcacef8a98fa2a4b7") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Cointaft: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Cointaft: 2 minutes
         ...
         */
        pchMessageStart[0] = 0x72;//T
        pchMessageStart[1] = 0x74;//A
        pchMessageStart[2] = 0x6d;//F
        pchMessageStart[3] = 0x2e;//T
        nDefaultPort = 14277;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1678810092, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1678810092, 4656, 0x20001fff, 4, 5000 * COIN);
        ...
        // Cointaft script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Cointaft private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Cointaft BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Cointaft BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Cointaft BIP44 coin type is '5'
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Cointaft: 1 day
        consensus.nPowTargetSpacing = 60; // Cointaft: 1 minutes
        ...
        pchMessageStart[1] = 0x72; //A
        pchMessageStart[2] = 0x74; //F
        pchMessageStart[3] = 0x6d; //T
        nDefaultPort = 10228;
        ...
        vSeeds.emplace_back("tnet.cointaft.com");
        //vSeeds.emplace_back("tnet1.cointaft.com", true);
        //vSeeds.emplace_back("tnet2.cointaft.com", true);

        // Testnet Cointaft addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Cointaft script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Cointaft BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Cointaft BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Cointaft BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Cointaft: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Cointaft: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("cointaftevo.org",  "devnet-seed.cointaftevo.org"));

        // Testnet Cointaft addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Cointaft addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Cointaft script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Cointaft BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Cointaft BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Cointaft BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
