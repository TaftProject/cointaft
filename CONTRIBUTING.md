Contributing to Cointaft Core
============================

The Cointaft Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/TaftProject/cointaft/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Cointaft Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Cointaft
Network Protocol consensus changes.

Whether a pull request is merged into Cointaft Core rests with the project merge
...
Patches that change Cointaft consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cointaft consensus, it must have been
...
The review process is normally fairly responsive on the Cointaft Core repository, however
...
The project leader is the release manager for each Cointaft Core release.
